...
if (pinAns.pin === mypin) {
    ...
    let operations = await inquirer.prompt([
      ...
      if (operations.transaction === "withdraw") {
        ...
        if(transactionans.amount<myBalance){myBalance -= transactionans.amount;
       ...
       if(fastans.amount==="1000"){myBalance -= fastans.amount; 
        console.log(`your remaining balance is ${myBalance}`);
        
}if(fastans.amount==="2000"){myBalance -= fastans.amount; 
    console.log(`your remaining balance is ${myBalance}`);}

    if(fastans.amount==="5000"){myBalance -= fastans.amount; 
        console.log(`your remaining balance is ${myBalance}`);}
        if(fastans.amount==="500"){myBalance -= fastans.amount; 
            console.log(`your remaining balance is ${myBalance}`);
